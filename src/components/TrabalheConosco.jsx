    ...
    <section id="trabalhe-conosco" className="trabalhe-conosco">
      <div className="trabalhe-conosco-container">
        <div className="trabalhe-conosco-content">
          <h2 className="section-title">Trabalhe com a gente: oportunidades na Fênix Cred em São Paulo</h2>
          <p className="section-subtitle">
            Faça parte de uma equipe que transforma vidas através do crédito consignado em São Paulo
          </p>
          
          <div className="trabalhe-conosco-info">
            <div className="info-card" data-spotlight>
              <div className="info-icon">🎯</div>
              <h3>Missão</h3>
              <p>Democratizar o acesso ao crédito e transformar vidas</p>
            </div>
            
            <div className="info-card" data-spotlight>
              <div className="info-icon">💼</div>
              <h3>Oportunidades</h3>
              <p>Vagas para vendedores, analistas e gestores</p>
            </div>
            
            <div className="info-card" data-spotlight>
              <div className="info-icon">📈</div>
              <h3>Crescimento</h3>
              <p>Plano de carreira e desenvolvimento profissional</p>
            </div>
          </div>
