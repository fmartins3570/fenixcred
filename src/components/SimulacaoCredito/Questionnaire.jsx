...
export default function Questionnaire() {
  ...
  const startQuiz = useCallback(() => {
    ...
    trackEvent('InitiateCheckout', { content_name: 'Quiz Simulação Crédito Garantia' }, eventId)
  ...
  const handleAnswer = useCallback((questionId, answerValue) => {
    ...
    if (question.type === 'tenure') {
      trackCustomEvent('PreQualTenure', {
        content_name: 'Quiz Simulação Crédito Garantia',
  ...
  const handleWhatsApp = useCallback(() => {
    ...
    trackEvent('Contact', { content_name: 'Quiz Simulação Crédito Garantia - WhatsApp', content_category: 'whatsapp' }, contactEventId)
