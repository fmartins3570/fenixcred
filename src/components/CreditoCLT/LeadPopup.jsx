...
export default function LeadPopup() {
  ...
  const handleStep1Submit = (e) => {
    ...
    trackEvent('InitiateCheckout', { content_name: 'LeadPopup Step1', value: 5, currency: 'BRL' }, eventId)
    sendServerEvent('InitiateCheckout', eventId, {
      name: name.trim(),
      phone: phone.replace(/\D/g, ''),
      page: window.location.pathname,
    }, { value: 5, currency: 'BRL', content_name: 'LeadPopup Step1' })
    setStep(2)
  }
