      ...
      <div className="faq-container">
        <div className="faq-content">
          ...
          <div className="faq-cta">
            ...
            <a
              href="https://wa.me/5511917082143?text=Olá! Tenho algumas dúvidas sobre o crédito consignado CLT."
              target="_blank"
              rel="noopener noreferrer"
              className="faq-whatsapp-link"
              onClick={() => trackEvent('Contact', { content_name: 'FAQ CLT WhatsApp', content_category: 'whatsapp' })}
            >
