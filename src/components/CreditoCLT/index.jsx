...
/**
 * Landing Page Credito Consignado CLT
 *
 * @param {boolean} personalized - Se true, exibe popup de captura + hero personalizado
 *   /page-credito-clt → personalized=false (padrao)
 *   /page-credito-clt-personalizado → personalized=true
 */
export default function CreditoCLT({ personalized = false }) {
  return (
    <div className="credito-clt-page">
      <SchemaJSON />
      <HeaderCLT />
      <main>
      ...
      {/* Lead Capture Popup - apenas na versao personalizada */}
      {personalized && <LeadPopup />}
